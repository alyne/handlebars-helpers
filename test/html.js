...
describe('html', function () {
  describe('attr', function () {
    it('should strip html from a string.', function () {
      var actual = hbs.compile('<div{{{attr class=foo}}}></div>')({
        foo: 'btn'
      });
  ...
  describe('css', function () {
    ...
    it('should use options.assets', function () {
      ...
      assert.equal(
        actual,
        '<link type="text/css" rel="stylesheet" href="foo/abc.css">'
      );
    });
    ...
    it('should not use options.assets when passing in an absolute url', function () {
      var actual = hbs.compile('{{{css "https://abc.com/bar.css"}}}')({
        options: { assets: 'foo' }
      });
      assert.equal(
        actual,
        '<link type="text/css" rel="stylesheet" href="https://abc.com/bar.css">'
      );
    });
