...
describe('matching', function () {
  describe('match', function () {
    ...
    it('should take options from the hash', function () {
      ...
      assert(
        /\.gitignore/.test(hbs.compile('{{match files "*" dot=true}}')(ctx))
      );
      assert(
        !/\.gitignore/.test(hbs.compile('{{match files "*" dot=false}}')(ctx))
      );
    });
    ...
    it('should take options passed as the last argument', function () {
      ...
      assert(
        /\.gitignore/.test(hbs.compile('{{match files "*" options}}')(ctx))
      );
    });
  });
