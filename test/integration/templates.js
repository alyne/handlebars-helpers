...
describe('templates integration tests', function () {
  ...
  describe('absolute', function () {
    it('should create an absolute file path', function () {
      assert.equal(
        render('{{absolute "a/b/c/package.json"}}'),
        path.resolve('a/b/c/package.json')
      );
      assert.equal(
        render('{{absolute "a/b/c/docs/toc.md"}}'),
    ...
    it('should use the cwd on locals', function () {
      assert.equal(
        render('{{absolute "a/b/c/package.json"}}', { cwd: os.homedir() }),
      ...
      assert.equal(
        render('{{absolute "a/b/c/docs/toc.md"}}', { cwd: os.homedir() }),
        path.resolve(os.homedir(), 'a/b/c/docs/toc.md')
      );
    });
  });
